<div class="dlabnav">
    <div class="dlabnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow" href="{{asset("assets/javascript:void()")}}" aria-expanded="false">
                    <i class="la la-home"></i>
                    <span class="nav-text">Dashboard</span>
                </a>
                <ul aria-expanded="false">
                    <!--* index file --->
                    <li><a href="{{route('/')}}">Dashboard 1</a></li>

                    <li><a href="{{route('/dashboard_two')}}">Dashboard 2</a></li>
                    <li><a href="{{route('admin.dashboard_three')}}">Dashboard 3</a></li>
                </ul>
            </li>
            ...
            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    {{-- Profrssor Routes --}}
                    <li><a href="{{route('admin.professors.all-professors')}}">All Professor</a></li>
                    <li><a href="{{route('admin.professors.add_professor')}}">Add Professor</a></li>
                    <li><a href="{{route('admin.professors.edit_professor')}}">Edit Professor</a></li>
                    <li><a href="{{route('admin.professors.profile_professor')}}">Professor Profile</a></li>
                </ul>
            </li>
            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
