...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('assets/images/favicon.png')}}">
    	<link href="{{asset('assetd/vendor/bootstrap-select/dist/css/bootstrap-select.min.cs{{asset('assets/    	<link href="{{asset('assetd/vendor/bootstrap-select/dist/css/bootstrap-select.min.css')}}" rel="stylesheet">')}}')}}" rel="stylesheet">
